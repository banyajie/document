...
- 切换模式 - live/game/list/v2        已配置
- 游戏列表 - 分享场景    /game/list     已配置
- 所有游戏列表   /sg/game/all/list      已配置
- 全部游戏基本模式列表  /game/base/mode/list    已配置
- 游戏教程：    已配置
- 
...
- 吕雷
  ...
  涉及工程：
  live.manager.base  banyajie    已上线

  live.voiceroom.logic ll

  imcenter.room.logic   ll

  mediacenter.live.base 已上线

  live.ktv.logic ll

  commerce.sendgift.buz ll

  

  mediacenter.live.logic ll
...
#成就触发事件
[[kafka_consume]]
	consume_from="achievement_event"
	zkpoints="10.55.3.219:2181,10.55.8.164:2181,10.55.3.220:2181,10.55.4.24:2181,10.55.8.164:2181/config/inke/inf/mq/ali-kafka01"
	topic = "inno_socialgame_activity_achievement_event"
	group = "cop.inke_owt.inno_pdl.socialgame-activity_achivement_logic_event_test"
	worker_number = 4
	initoffset=-1
	process_timeout = 10
	commit_interval = 10
...
[[kafka_producer_client]]
   producer_to = "kafka.sync_producer.achievement"
   kafka_broken ="ali-f-inf-kafka-test23.bj:9092,ali-f-inf-kafka-test24.bj:9092,ali-f-inf-kafka-test25.bj:9092,ali-f-inf-kafka-test26.bj:9092,ali-f-inf-kafka-test27.bj:9092"
   retrymax = 3
   get_error = true
   get_success = true
...
![image-20221014100336391](/Users/banyajie/Library/Application Support/typora-user-images/image-20221014100336391.png)





http://media.thlrs.com/record_166419038800Ptgf/1665734277.mp4

![image-20221014100407219](/Users/banyajie/Library/Application Support/typora-user-images/image-20221014100407219.png)



![image-20221014100601123](/Users/banyajie/Library/Application Support/typora-user-images/image-20221014100601123.png)
...
- 长链接
					...
					狼人真言/飞行棋/指尖球球/长颈鹿/色盲游戏/王者荣耀/开挂人生/桌球
